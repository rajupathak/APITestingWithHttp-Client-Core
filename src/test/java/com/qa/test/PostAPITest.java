...
public class PostAPITest extends TestBase {
	...
	public void postAPITest() throws ClientProtocolException, IOException {
		...
		Users userObject = new Users("Rajesh", "AutomationTester");

		String entityObject = mapper.writeValueAsString(userObject);
		CloseableHttpResponse closeableHttpResponse = restClient.post(uri,
				entityObject, Headers.getHeader());

		int statusCode = closeableHttpResponse.getStatusLine().getStatusCode();
		System.out.println("Status Code Is : " +statusCode);

		Assert.assertEquals(statusCode, testbaseoj.RESPONSE_STATUS_CODE_201);
